...
class FetchEventSource {
    ...
    async _handleContent(res) {
        // TODO: call reader.cancel() when stopping to speed up shutdown and avoid processing a backlog of messages after stopping
    ...
    async _handleError(error) {
        ...
        this.close();  // close before invoke onError avoiding race condition with potentially re-connected event source
